  ...
  const data = {
    projects: [
      ...
      },
      {
        ...
        context: "CODE University of Applied Sciences",
        contextLink: "https://code.berlin",
        learned: "Teamwork, Eventmanagement, Partnerships, Sales & Keeping cool in stressfull situations",
      ...
      },
      {
        ...
        role: "Data Scientist",
        roleDescription: "Data Science in Python (Pandas, Numpy, Matplotlib, Seaborn)",
        teamsize: "2",
        context: "CODE University of Applied Sciences",
        contextLink: "https://code.berlin",
        learned: "Extensive experience in Data Science. Data cleaning, statistical methods, visualizing methods and how to present data in a meanigful way.",
      ...
      },
      {
        ...
        learned: "Understanding of energy infrastructure, Calculation of capital investments in infrastructure.",
