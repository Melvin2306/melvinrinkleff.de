export default function dataprovider (params: Array) {
    const data: {
    ...
    education: [
        {
          ...
          institution: "NTNU - Norwegian University of Science and Technology",
          period: "August 2023 - Dezember 2023",
          location: "Gjøvik, Norwegen",
          courses: [
          ],
          url: "https://www.ntnu.edu",
        },
        {
          ...
          projects: [
            "//Slash Hackathon",
            "Erstellen einer eigenen Web Applikation",
            "Forschungsprojekt im Bereich von sexuellen Beziehungen und sexueller Befriedigung",
            "Spotify Daten Analyse",
            "Gruppen Projekt Full Stack Web Applikation",
          ],
          url: "https://code.berlin",
        },
        {
          degree:
            "Bachelor Betriebswirtschaftslehre (Fachrichtung Energiewirtschaft) ",
          institution: "Hochschule Weserberland",
          period: "2018 - 2021",
          location: "Hameln, Deutschland",
          project:
            "Transformation der aktuellen Gas Infrastuktur in Deutschland zu einer Wasserstoff Infrastruktur",
          url: "https://www.hsw-hameln.de",
        },
      ],
      experience: [
